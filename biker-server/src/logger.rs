...
pub fn init(verbosity: &Level) {
    ...
    logger = match verbosity {
        Level::Warn => logger.level_for("forum_server", log::LevelFilter::Warn),
        Level::Info => logger.level_for("forum_server", log::LevelFilter::Info),
        Level::Debug => logger.level_for("forum_server", log::LevelFilter::Debug),
        _ => logger.level_for("forum_server", log::LevelFilter::Trace),
    };
